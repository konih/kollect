...
| **Contributor** | Anyone opening a PR or issue | Follow [CONTRIBUTING.md](../CONTRIBUTING.md), [DCO](../DCO), and the [Code of Conduct](../CODE_OF_CONDUCT.md); propose changes via pull request |
...
| Change type | Process |
| --- | --- |
| **Architecture** (API shape, tenancy, sinks, multi-cluster, security posture) | Write or update an [ADR](adr/README.md); maintainer LGTM before merge |
...
| **Release tagging** | Maintainer-only; follows [RELEASE.md](RELEASE.md) |
...
**documented gaps** ([ADR-0705](adr/0705-release-supply-chain.md)).
...
| [ASSURANCE-CASE.md](ASSURANCE-CASE.md) | Security claims and countermeasures |
| [ADR-0104](adr/0104-security-model.md) | Consolidated security architecture |
